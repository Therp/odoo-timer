(function (exports) {
    ...
    class VHtml {
        ...
        mount(parent, afterNode) {
            this.parentEl = parent;
            // THERP SECURITY PATCH: raw OWL Markup/HTML rendering is disabled.
            //
            // Therp Timer uses precompiled templates and does not require raw
            // Markup injection. Fail closed: render Markup values literally.
            const textNode = document.createTextNode(String(this.html ?? ""));
        ...
        patch(other) {
            ...
            if (this.html !== html2) {
                ...
                // THERP SECURITY PATCH: keep VHtml fail-closed on updates too.
                const textNode = document.createTextNode(String(html2 ?? ""));
    ...
    function compile(template, options = {
        ...
        // THERP SECURITY PATCH: runtime OWL template compilation is disabled.
        //
        // Therp Timer ships precompiled templates. Runtime code generation via
        // Function() is unnecessary for the packaged extension/application.
        throw new OwlError(
            "Runtime OWL template compilation is disabled in Therp Timer. " +
            "Compile OWL XML templates before packaging."
        );
    }
