...
"PopupApp": function PopupApp(app, bdom, helpers
  ...
  let block1 = createBlock(`<div class="app-root"><div id="loader-container" block-attribute-0="class"><div class="loader-card"><div class="loader-text"><block-child-0/></div><div class="loader-subtext"> Please wait — or grab a cup of coffee ☕ </div><i class="fa fa-cog fa-spin fa-5x"/></div></div><div id="login" class="login-view" block-attribute-1="class"><div class="popup-login-shell"><div class="form"><div class="logo"><img block-attribute-2="src" alt="Remote logo"/></div><block-child-1/><block-child-2/><block-child-3/></div></div><div class="cta forgotpwd footer-app-opts login-footer-bar"><a href="options_main_page.html"><i class="fa fa-cogs"/> Options </a></div></div><div id="wrapper" block-attribute-3="class"><block-child-4/><div class="toolbar-row"><input id="searchIssue" type="text" placeholder="Search by ID, name, user, priority, stage..." block-property-4="value" block-handler-5="input"/><block-child-5/><select id="limitTo" block-property-6="value" block-handler-7="change" block-handler-8="change"><option value="10">10</option><option value="15">15</option><option value="25">25</option><option value="">All</option></select></div><div class="container footer top-actions"><div class="row"><div class="mx-3 col-md-12 footer-btns pointer"><i class="fa fa-download fa-2x" title="Download current month timesheet" block-handler-9="click"/><i class="fa fa-hand-o-left fa-2x" title="Switch between remotes" block-handler-10="click"/><i class="fa fa-refresh fa-2x" title="Refresh current items" block-handler-11="click"/><i class="fa fa-clock-o fa-2x" title="Discard the active timer" block-handler-12="click"/><i class="fa fa-sign-out fa-2x" title="Log out" block-handler-13="click"/><a href="options_main_page.html" class="options-btn" title="Go To options"><i class="fa fa-cogs fa-2x"/></a></div></div></div><div class="table-scroll"><table id="table-task-issues" class="table table-responsive-sm table-bordered table-fixed"><thead><tr><th class="action-col"><div/><block-child-6/></th><block-child-7/><block-child-8/></tr></thead><tbody><block-child-9/><block-child-9/><block-child-10/></tbody></table></div><div class="container footer info-footer" style="padding:12px 8px 10px;"><div class="text-center" style="margin-bottom:8px;"><img block-attribute-14="src" alt="Remote" style="width:72px;height:48px;object-fit:contain;background:#fff;border:1px solid #e2e8f0;border-radius:6px;padding:4px;"/><div style="margin-top:4px;font-size:12px;font-weight:600;"><block-child-11/><span class="current-source-chip" style="margin-left:5px;"><block-child-12/></span></div></div><div class="row remote-info-block" style="display:flex;flex-wrap:wrap;font-size:12px;line-height:1.35;"><div class="col-4 text-center" style="flex:0 0 33.333%;max-width:33.333%;padding:5px;word-break:break-word;"><b>Odoo</b><br/><span class="remote-value"><block-child-13/></span></div><div class="col-4 text-center" style="flex:0 0 33.333%;max-width:33.333%;padding:5px;word-break:break-word;"><b>Database</b><br/><span class="remote-value"><block-child-14/></span></div><div class="col-4 text-center" style="flex:0 0 33.333%;max-width:33.333%;padding:5px;word-break:break-word;"><b>Host</b><br/><span class="remote-value"><block-child-15/></span></div><div class="col-4 text-center" style="flex:0 0 33.333%;max-width:33.333%;padding:5px;word-break:break-word;"><b>User</b><br/><span class="remote-value"><block-child-16/></span></div><div class="col-4 text-center" style="flex:0 0 33.333%;max-width:33.333%;padding:5px;word-break:break-word;"><b>Current Company</b><br/><span class="remote-value"><block-child-17/></span></div><div class="col-4 text-center" style="flex:0 0 33.333%;max-width:33.333%;padding:5px;word-break:break-word;" block-attribute-15="title"><b>Allowed Companies</b><br/><span class="remote-value"><block-child-18/></span></div></div><div class="text-center text-muted" style="font-size:10px;margin-top:3px;"> OWL <span><block-child-19/></span></div></div></div></div>`);
  ...
  return function template(ctx, node, key = "") {
    let b2, b3, b5, b6, b19, b21, b25, b27, b36, b47, b86, b87, b88, b89, b90, b91, b92, b93, b94, b95;
    ...
    let attr13 = ctx['currentRemoteLogoSrc'];
    b87 = safeOutput((ctx['currentRemote']&&(ctx['currentRemote'].name||ctx['currentRemote'].database))||'Odoo');
    b88 = safeOutput(ctx['currentDataSourceLabel']);
    ...
    b92 = safeOutput(ctx['state'].user?ctx['state'].user.display_name:'-');
    b93 = safeOutput(ctx['currentCompanyLabel']);
    let attr14 = ctx['allowedCompanyLabels'];
    b94 = safeOutput(ctx['allowedCompanySummary']);
    b95 = safeOutput(ctx['state'].odooOWLVersion||'Unknown');
    return block1([attr1, attr2, attr3, attr7, prop5, hdlr7, prop8, hdlr9, hdlr10, hdlr11, hdlr12, hdlr13, hdlr14, hdlr15, attr13, attr14], [b2, b3, b5, b6, b19, b21, b25, b27, b36, b47, b86, b87, b88, b89, b90, b91, b92, b93, b94, b95]);
  }
},
