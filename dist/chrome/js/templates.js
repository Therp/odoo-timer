export const templates = {
 "OptionsApp": function OptionsApp(app, bdom, helpers
  ...
  let block6 = createBlock(`<tr><td class="text-info"><block-child-0/></td><td><block-child-1/></td><td><block-child-2/></td><td><block-child-3/></td><td><block-child-4/></td><td class="remote-row-actions"><i class="fa fa-trash text-danger" title="Remove remote" block-handler-0="click"/></td></tr>`);
  ...
  return function template(ctx, node, key = "") {
    ...
    let hdlr10 = [ctx['addRemote'], ctx];
    let hdlr11 = [ctx['loadRemotes'], ctx];
    const v8 = ctx['state'];
    let hdlr12 = [()=>v8.showList=!v8.showList, ctx];
    let hdlr13 = [ctx['removeAllRemotes'], ctx];
    if (ctx['state'].error) {
    ...
    if (ctx['state'].showList&&ctx['state'].remotes.length) {
      ...
      for (let i1 = 0; i1 < l_block5; i1++) {
        ...
        const v9 = ctx['removeRemote'];
        const v10 = ctx['remote'];
        let hdlr14 = [()=>v9(v10), ctx];
        c_block5[i1] = withKey(block6([hdlr14], [b7, b8, b9, b10, b11]), key1);
      }
      ctx = ctx.__proto__;
      const b5 = list(c_block5);
      b4 = block4([], [b5]);
    }
    return block1([attr1, hdlr1, attr2, hdlr2, attr3, attr4, hdlr3, prop1, hdlr4, prop2, hdlr5, prop3, hdlr6, prop4, hdlr7, prop5, hdlr8, prop6, hdlr9, hdlr10, hdlr11, hdlr12, hdlr13], [b2, b4]);
  }
},
...
"PopupApp": function PopupApp(app, bdom, helpers
  ...
  let block23 = createBlock(`<th class="text-center">Hours Spent</th>`);
  let block24 = createBlock(`<th class="text-center">Hours Left</th>`);
  ...
  let block35 = createBlock(`<td class="text-center"><block-child-0/></td>`);
  let block37 = createBlock(`<td class="text-center"><block-child-0/></td>`);
  ...
  return function template(ctx, node, key = "") {
    ...
    return block1([attr1, attr2, attr6, prop5, hdlr7, prop6, hdlr8, hdlr9, hdlr10, hdlr11, hdlr12, hdlr13, hdlr14, prop7, hdlr15], [b2, b4, b5, b18, b20, b21, b22, b25, b40, b41, b42, b43, b44, b45]);
  }
},
