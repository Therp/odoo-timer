...
"PopupApp": function PopupApp(app, bdom, helpers
  ...
  return function template(ctx, node, key = "") {
    ...
    if (ctx['state'].timerStartIso) {
      ...
      let hdlr19 = [ctx['resetTimer'], ctx];
      b17 = block17([txt10, hdlr19]);
    }
    if (ctx['isHelpdeskSource']) {
      ...
      let hdlr20 = [(_ev)=>v7(_ev.target.checked), ctx];
      b21 = block21([txt11, txt12, prop10, hdlr20]);
      b22 = block22();
      ...
      let hdlr21 = [(_ev)=>v8(_ev.target.checked), ctx];
      b28 = block28([txt13, txt14, prop11, hdlr21]);
    ...
    if (ctx['filteredIssues'].length) {
      ...
      for (let i1 = 0; i1 < l_block33; i1++) {
        ...
        if (ctx['isActiveTimerItem'](ctx['ir'])) {
          ...
          const v12 = ctx['ir'];
          let hdlr23 = [()=>v11(v12), ctx];
          b36 = block36([attr11, hdlr23]);
        } else {
          const v13 = ctx['startTimer'];
          const v14 = ctx['ir'];
          let hdlr24 = [()=>v13(v14), ctx];
          b37 = block37([hdlr24]);
        }
        if (ctx['isHelpdeskSource']) {
          ...
          if (ctx['state'].dataSource==='project.task') {
            ...
            const v16 = ctx['ir'];
            let hdlr25 = [()=>v15(v16), ctx];
            const b67 = block67([hdlr25], [b68]);
    ...
    let txt16 = ctx['state'].serverVersion||'N/A';
    let txt17 = ctx['owlVersion'];
    let txt18 = ctx['state'].currentHost||'—';
    let txt19 = ctx['state'].currentDatabase||'—';
    let txt20 = (ctx['state'].user&&ctx['state'].user.display_name)||'—';
    let txt21 = ctx['currentCompanyLabel'];
    let attr14 = ctx['allowedCompanyLabels'];
    let txt22 = ctx['allowedCompanyLabels']||'—';
    return block1([attr1, txt1, attr2, attr3, attr7, prop5, hdlr7, prop8, hdlr9, prop9, hdlr10, hdlr11, hdlr12, hdlr13, hdlr14, hdlr15, hdlr16, hdlr17, attr9, txt9, hdlr18, txt16, txt17, txt18, txt19, txt20, txt21, attr14, txt22], [b2, b3, b4, b13, b14, b17, b18, b25, b33, b73]);
  }
},
